...
const triggerNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    label: "Stripe",
    desc: "Runs the flow when a Stripe event is captured",
    icon: "/stripe.svg",
  },
];
        ...
        <div>
          {triggerNodes.map((nodeType) => {
            ...
            return (
              <div
                key={nodeType.type}
                className="w-full justify-start h-auto py-5 px-4 cursor-pointer rounded-none border-l-2 border-transparent hover:border-l-primary"
